...
If the researcher finds a difference in the rate of stroke occurrence between the two groups can she conclude that exercise is the cause of the difference?
    ...
    A. Yes, because this is a controlled experiment
    B. Yes, because this is an observational study
    C. No, because this is a controlled experiment
    D. No, because this is an observational study
...
25. A system contains two components, A and B. The system will only function if both A and B function. The probability that A functions is 0.98, the probability that B functions is 0.95, and the probability that either A or B functions is 0.99. What is the probability that the system functions?
...
30. A vendor begins using heavier packaging, which increases the weight of each package she sends out by 50 g. How does this change affect the mean and standard deviation?
    ...
    A. Both the mean and the standard deviation remain unchanged
    B. The mean remains unchanged but the standard deviation increases
    C. The mean increases but the standard deviation remains unchanged
    D. Both the mean and the standard deviation increase
    E. None of the above
...
36. Let X = the number of text messages received in a 30 minute period. Assume that the average number of messages is the same for any given 30 minute period. What is the best distribution for modelling X?
...
What is the z-score for one randomly selected shuttle trip that is 30 minutes long?
    ...
    C. 2.0
    D. 3.5
    E. It is not appropriate to compute the z-score since the distribution of shuttle trips is not normally distributed
...
What is the z-score of the mean of the 78 shuttle trips if the mean is 30 minutes?
    ...
    C. 2.0
    D. 3.5
    E. It is not appropriate to compute the z-score since the distribution of the means of n = 78 shuttle trips is not normally distributed
